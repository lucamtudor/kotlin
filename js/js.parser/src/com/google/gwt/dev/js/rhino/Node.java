...
public class Node implements Cloneable {
    ...
    private static class NumberNode extends Node {
        ...
        NumberNode(int number, Location location) {
            super(TokenStream.NUMBER_INT, location);
            this.number = number;
        }

        NumberNode(double number, Location location) {
    ...
    private static class StringNode extends Node {
        ...
        StringNode(int type, String str, Location location) {
            super(type, location);
            if (null == str) {
    ...
    public Node(int nodeType, Node child, Location location) {
        type = nodeType;
        first = last = child;
        child.next = null;
    ...
    public Node(int nodeType, Node child, int operation, Location location) {
        type = nodeType;
        first = last = child;
        child.next = null;
    ...
    public Node(int nodeType, Node left, Node right, Location location) {
        this(nodeType, left, right, -1, location);
    }

    public Node(int nodeType, Node left, Node right, int operation, Location location) {
        type = nodeType;
        first = left;
        last = right;
        left.next = right;
    ...
    public Node(int nodeType, Node left, Node mid, Node right, Location location) {
        type = nodeType;
        first = left;
        last = right;
        left.next = mid;
    ...
    public Node(int nodeType, Node left, Node mid, Node mid2, Node right, Location location) {
        type = nodeType;
        first = left;
        last = right;
        left.next = mid;
    ...
    public Node(int nodeType, Location location) {
        type = nodeType;
        this.location = location;
    }

    public Node(int nodeType, int operation, Location location) {
        type = nodeType;
        this.operation = operation;
        this.location = location;
    }

    public static Node newNumber(int number, Location location) {
        return new NumberNode(number, location);
    }

    public static Node newNumber(double number, Location location) {
        return new NumberNode(number, location);
    }

    public static Node newString(String str, Location location) {
        return new StringNode(TokenStream.STRING, str, location);
    }

    public static Node newString(int type, String str, Location location) {
