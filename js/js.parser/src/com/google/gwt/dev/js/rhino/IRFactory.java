...
public class IRFactory {
     ...
     * Leaf
     */
    public Node createLeaf(int nodeType, Location location) {
        return new Node(nodeType, location);
    }

    public Node createLeaf(int nodeType, int nodeOp, Location location) {
    ...
    public Node createSwitch(Location location) {
        return new Node(TokenStream.SWITCH, location);
    }

    public Node createVariables(Location location) {
        return new Node(TokenStream.VAR, location);
    }

    public Node createExprStatement(Object expr, Location location) {
     ...
     * Name
     */
    public Node createName(String name, Location location) {
     ...
     * String (for literals)
     */
    public Node createString(String string, Location location) {
     ...
     * Number (for literals)
     */
    public Node createNumber(int number, Location location) {
        return Node.newNumber(number, location);
    }

    public Node createNumber(double number, Location location) {
        return Node.newNumber(number, location);
    }
     ...
     */
    public Node createCatch(Node varName, Node catchCond, Node stmts, Location location) {
        if (catchCond == null) {
     ...
     * Throw
     */
    public Node createThrow(Node expr, Location location) {
     ...
     * Return
     */
    public Node createReturn(Node expr, Location location) {
        return expr == null
     ...
     * Label
     */
    public Node createLabel(Node label, Location location) {
     ...
     */
    public Node createBreak(Node label, Location location) {
     ...
     */
    public Node createContinue(Node label, Location location) {
     ...
     * debugger
     */
    public Node createDebugger(Location location) {
     ...
     */
    public Node createBlock(Location location) {
     ...
     * While
     */
    public Node createWhile(Node cond, Node body, Location location) {
     ...
     * DoWhile
     */
    public Node createDoWhile(Node body, Node cond, Location location) {
     ...
     * For
     */
    public Node createFor(Node init, Node test, Node incr, Node body, Location location) {
     ...
     *
     */
    public Node createForIn(Node lhs, Node obj, Node body, Location location) {
     ...
     * Try/Catch/Finally
     */
    public Node createTryCatchFinally(Node tryblock, Node catchblocks, Node finallyblock, Location location) {
     ...
     * With
     */
    public Node createWith(Node obj, Node body, Location location) {
     ...
     * Regular expressions
     */
    public Node createRegExp(String string, String flags, Location location) {
     ...
     * If statement
     */
    public Node createIf(Node cond, Node ifTrue, Node ifFalse, Location location) {
        if (ifFalse == null)
            return new Node(TokenStream.IF, cond, ifTrue, location);
        return new Node(TokenStream.IF, cond, ifTrue, ifFalse, location);
    }

    public Node createTernary(Node cond, Node ifTrue, Node ifFalse, Location location) {
     ...
     * Unary
     */
    public Node createUnary(int nodeType, Node child, Location location) {
        return new Node(nodeType, child, location);
    }

    public Node createUnary(int nodeType, int nodeOp, Node child, Location location) {
     ...
     * Binary
     */
    public Node createBinary(int nodeType, Node left, Node right, Location location) {
        switch (nodeType) {
    ...
    public Node createBinary(int nodeType, int nodeOp, Node left, Node right, Location location) {
    ...
    public Node createAssignment(int nodeOp, Node left, Node right, Location location) {
